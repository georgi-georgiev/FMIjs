...
(function(factory){
  ...
  $.extend(Sammy.Object.prototype, {
    ...
    toHTML: function() {
      ...
      $.each(this, function(k, v) {
        if (!_isFunction(v)) {
          displayout += "<strong>" + k + "</strong> " + v + "<br />";
        }
      });
      return displayout;
    },
...
$.extend(Sammy.DefaultLocationProxy.prototype , {
  ...
  Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    //
    //
    // It really comes to playout when doing asynchronous:
    //
    //      app.get('/chain',function(context,next) {
    //        $.get('/my/url',function() {
    //          console.log('chain1');
    ...
    // e.g logging to a server side component or displayouting some feedback to the
    // user.
